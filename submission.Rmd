...
I have my ordered p-values, $\{ P_1, P_2, ... \: , P_m \}$, and want the FWER to be no higher than a level $\alpha$. Is $P_1 < \alpha/m$? so, reject $H_1$ and continue to the next step, otherwise EXIT. Is $P_2 < \alpha/(m-1)$? so, reject $H_2$ and continue to the next step, otherwise EXIT.
